import * as JSOG from 'jsog'; //package that enables parsing JSON as graphs
...
export default class App extends React.PureComponent {
  ...
  render() {
    ...
    return(
      <div>
      <h1 style={{ textAlign: 'center'}}>get ready for some nensense, boys</h1>
        <h3>Configuration</h3>
          <ul>
            <li>
  ...
  handleClick = (game: Model.Game) => alert('clicked game: ' + game.name);

  gameComponent = (props: any) => {
    return (
      <BracketGame
        {...props}
        onHoveredTeamIdChanges = {this.changeHoveredTeamId }
